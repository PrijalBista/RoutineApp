...
export default class Assignment extends Component {
  ...
  static navigationOptions ={
  	drawerIcon:(
  		<Image source={require('../assets/DrawerIcons/assignment.jpg')}
  ...
  fetchAssignments(pulled){
    ...
    return fetch('http://jyashaa.com/killemall/JSON.php')
      ...
      .then((responseJson)=>{
        ...
        AsyncStorage.setItem('cachedData', JSON.stringify(responseJson)).done();      
      }).catch((error)=>{
  ...
  renderAssignments(){
    if(this.state.isLoading){
      ...
      let labno=[[],[]];
      let labsarr=[];
      var labObj = this.state.data.Assignments;
      ...
      <Container>
            ...
            <Right/>  
              ...
              <RefreshControl
                ...
                onRefresh={this.fetchAssignments.bind(this,true)}
              /> }
            >
